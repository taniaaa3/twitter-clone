...
const Login = () => {
    ...
    return (
        <div className="w-screen h-screen m-0 bg-gray-200 flex justify-center items-center">
            ...
            <div className="flex flex-col rounded-xl sm:flex-row justify-center items-center text-white h-96 w-4/5 md:w-1/2">
                <div className="bg-blue-500 w-full sm:rounded-tl-lg sm:rounded-bl-lg flex sm:px-5 px-2 py-5 sm:py-0 h-full flex-col justify-center items-center">
                ...
                <div className="flex flex-col h-full w-full sm:rounded-tr-lg sm:rounded-br-lg px-5 bg-white text-black justify-center w-3/4">
                    <form className="flex flex-col" onSubmit={loginUser}>
                        ...
                        <button type="submit" className="w-max m-3 rounded-lg bg-black px-4 py-2 text-white cursor-pointer">{loginLoading ? "Logging in..." : "Login"}</button>
                    </form>
